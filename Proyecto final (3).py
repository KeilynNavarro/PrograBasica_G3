...
servicio.write(serv)
servicio.close()
archivo=open("informacion_Clientes.txt","w")
archivo.close()
...
def usuario_Registrado():
    ...
    perfil=118080084
    contra=1234
    cuentas=['118080084',4000000,5000,2.5]
    servicios_Cliente=[5000,25000,6000]
    contador=1
    ...
    #perfil_Archivo=perfiles[0]
    #archivo.close()
    while usuario!=perfil:
        for i in range(2):
            print('')
    ...
    #        usuario=int(input('Ingrese su numero de cédula: '))
    #        contador=contador+1
    if usuario==perfil or usuario==perfil_Archivo:
        print('')
        senha=int(input('Ingrese su contrasena: '))
        #archivo=open("informacion_Clientes.txt","r")
        #informacion=archivo.readlines()
        #perfiles=[input(i) for i in informacion]
        #contra_Archivos=perfiles[0]
        #contra_Archivo=contra_Archivos[2]
        #print(contra_Archivo)
        #archivo.close()
        if senha!=contra:
            for i in range(2):
                print('')
            ...
            if entrada2==1:
                ...
                if entrada3==1:
                    ...
                    #cuentas=[input(i) for i in cuenta_Colones]
                    cuentas_Colon=[]
                    cuentas_Colon.append(cuentas[1])
                    #archivo.close()
                    if retiro>cuentas_Colon[0]:
                        for i in range(2):
                            print('')
                            print('El monto que desea retirar es invalido, digite el monto nuevamente')
                            print('')
                            retiro=float('Cual es el monto que desea retirar: ')
                    elif retiro <= cuentas_Colon[0]:
                        cuentas_Colon[0]=cuentas_Colon[0]-retiro
                        cuentas[1]=cuentas_Colon[0]
                        #archivo=open("cuentas.txt","a")
                        #archivo.write(lista)
                        #archivo.close()
                        print('')
                    ...
                    cuentas_Dolar=[]
                    cuentas_Dolar.append(cuentas[2])
                    #archivo.close()
                    if retiro>cuentas_Dolar[0]:
                        for i in range(2):
                            print('')
                            print('El monto que desea retirar es invalido, digite el monto nuevamente')
                            print('')
                            retiro=float('Cual es el monto que desea retirar: ')
                            if retiro <= cuentas_Dolar[0]:
                                cuentas_Dolar[0]=cuentas_Dolar[0]-retiro
                    ...
                    cuentas_Bit=[]
                    cuentas_Bit.append(cuentas[3])
                    #archivo.close()
                    if retiro>cuentas_Bit[0]:
                        for i in range(2):
                            print('')
                            print('El monto que desea retirar es invalido, digite el monto nuevamente')
                            print('')
                            retiro=float('Cual es el monto que desea retirar: ')
                    elif retiro <= cuentas_Bit[0]:
                            cuentas_Bit[0]=cuentas_Bit[0]-retiro
                            cuentas[3]=cuentas_Bit
                    #   archivo=open("cuentas.txt","a")
                    #   archivo.write(lista)
                    #   archivo.close()
                            print('')
                ...
                print('')
                print('Colones: ',cuentas[1])
                print('Dolares: ',cuentas[2])
                print('Bitcoin: ',cuentas[3])
                print('')
                usuario_Registrado()
            elif entrada2==4:
                print('')
                ...
                if entrada==1:
                    ...
                    #       lista2=[input(i) for i in conversion_Dolares]
                            conversion_Dolar=[]
                            conversion_Dolar.append(conver_Dolares[1])
                    #       archivo.close()
                    ...
                    #       lista2=[input(i) for i in conversion_Bitcoin]
                            conversion_Bit=[]
                            conversion_Bit.append(conver_Bitcoin[1])
                    #       archivo.close()
                    ...
                    #           lista2=[input(i) for i in conversion_Dolares]
                            conversion_Dolar=[]
                            conversion_Dolar.append(cover_Dolares[1])
                    #           archivo.close()
                            conversion_Cuenta_Dolar=valor*conversion_Dolar[0]
                            if valor>conversion_Cuenta_Dolar[0]:
                                for i in range(2):
                    ...
                    #           lista2=[input(i) for i in conversion_Bitcoin]
                            conversion_Bit=[]
                            conversion_Bit.append(conver_Bit[1])
                    #           archivo.close()
                            conversion_Cuenta_Bit=valor*conversion_Bit[0]
                            if valor>conversion_Cuenta_Dolar[0]:
                                for i in range(2):
                ...
                if entrada3==1:
                    ...
                    #       lista=[input(i) for i in cuenta_Colones]
                            ...
                            cuentas_Colon.append(cuentas[1])
                    #       archivo.close()
                            cuentas_Colon=cuentas_Colon+venta
                            cuentas[1]=cuentas_Colon
                    #       archivo=open("cuentas.txt","a")
                    #       archivo.write(lista)
                    #       archivo.close()
                    ...
                    #       lista=[input(i) for i in cuenta_Bitcoin]
                            cuentas_Bit=[]
                            cuentas_Bit.append(cuentas[1])
                            conversion_Cuenta_Bit=venta*(conversion_Bit[0])
                            cuentas_Bit[0]=(cuentas_Bit[0])+(conversion_Cuenta_Bit)
                            cuentas[3]=cuentas_bit[0]
                    #       archivo=open("cuentas.txt","a")
                    #       archivo.write(lista)
                    #       archivo.close()
                            print('')
